...
const TIERS: Record<"high" | "mid", Tier> = {
  high: { heads: 44, dustCount: 1100, bokehCount: 18, stamensPerHead: 26, maxPixelRatio: 2 },
  ...
  mid: { heads: 26, dustCount: 500, bokehCount: 6, stamensPerHead: 16, maxPixelRatio: 1.5 },
};
