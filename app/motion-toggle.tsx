 ...
 *
 * The control is hidden entirely under reduced motion (CSS), because there is nothing to pause.
 *
 * IT RENDERS NOTHING UNTIL MOUNTED. A pause button in static HTML that does nothing until
 * hydration is a control that lies for its first few hundred milliseconds.
 */
